...
export const sndCal = [
  ...
  // --------
  {
    id: 11,
    title: "Day Shift",
    start: new Date(2015, 4, 23, 8, 0, 0),
    end: new Date(2015, 4, 25, 8, 30, 0),
    shift: "day",
  },
  ...
  // ----------------
  {
    id: 12.5,
    title: "Night Shift",
    start: new Date(2015, 4, 26, 22, 30, 0),
    end: new Date(2015, 4, 30, 24, 30, 0),
    shift: "night",
  },
  // -----------
  // {
